...
public class Threader {
    ...
    public static OrderList ActiveOrders = new OrderList();
    public static OrderList HistoryOrders = new OrderList();
        ...
        public void run() {
            ...
            //while (true) {
                try {
                    ...
                    Screen.updateActiveOrder(ActiveOrders);
    ...
    public static class PLCHandler implements Runnable {
        ...
        public void run() {
            ...
            try{
                ...
                Screen.updateActiveOrder(ActiveOrders);
                ActiveOrders.printList();
                HistoryOrders.addOrder(ReceivedOrder);
                Screen.updateOldOrder(HistoryOrders);
